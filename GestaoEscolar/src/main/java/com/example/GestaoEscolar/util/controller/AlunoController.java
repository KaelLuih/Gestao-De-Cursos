...
private final AlunoService service;
    ...
    @PostMapping
    public AlunoResposta create(@Valid @RequestBody AlunoRequisicao requisicao){
        try {
    ...
    @PutMapping("/{id}")
    public AlunoResposta update(@Valid @RequestBody AlunoRequisicao requisicao, @PathVariable int id){
        try{
